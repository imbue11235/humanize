...
var Locale = locale.Map{
	...
	"time": locale.Map{
		...
		"estimation": locale.Map{
			"s": "‎[1] ثانية‎ | [2]	ثانيتين‎ | [3-10] ثواني %d | [11-*] ثانية %d",
			"m": "‎[1]‎ دقيقة‎‎ | [2] دقيقتين‎ | [3-10] دقائق‎‎ %d | [11-*]‎ دقيقة‎ %d",
			"h": "[1] ساعة‎ | [2] سعاتين‎ | [3-10] ساعات‎ %d | [11-*] ساعة‎ %d",
			"d": "[1] يوم‎ | [2] يومين‎ | [3-10] ايام‎ %d | [11-99] يوما‎ %d | [100-*] يوم ",
			"w": "[1] اسبوع‎ | [2] اسبوعين‎ | [3-10] اسابيع‎ %d | [11-99] اسبوعا ‎%d | [100-*] اسبوع",
			"M": "[1] شهر‎ | [2] ‎شهرين‎ | [3-10] اشهر‎ %d | [11-99] شهرا %d | [100-*] شهر",
			"y": "[1] سنة‎ | [2] سنتين‎ | [3-10] سنين‎ %d‎‎ | [11-*] سنة‎ %d",
			"D": "[1] عقد‎ | [2] ‎عقدين‎ | [3-10] عقود‎ %d | [11-99] عقدا %d | [100-*] عقد",
			"l": "وقت طويل",
		},‎‎
		"precision": locale.Map{
			"s": "‎[1] %d ثانية‎ | [2] %d ثانيتين‎ | [3-10] ثواني %d | [11-*] ثانية %d",
			"m": "‎[1]‎ %d دقيقة‎‎ | [2] %d دقيقتين‎ | [3-10] دقائق‎‎ %d | [11-*]‎ دقيقة‎ %d",
			"h": "[1] %d ساعة‎ | [2] %d سعاتين‎ | [3-10] ساعات‎ %d | [11-*] ساعة‎ %d",
			"d": "[1] %d يوم‎ | [2] %d يومين‎ | [3-10] ايام‎ %d | [11-99] يوما‎ %d | [100-*] يوم ",
			"M": "[1] %d شهر‎ | [2] %d ‎شهرين‎ | [3-10] اشهر‎ %d | [11-99] شهرا %d | [100-*] شهر",
			"y": "[1] %d سنة‎ | [2] %d سنتين‎ | [3-10] سنين‎ %d‎‎ | [11-*] سنة‎ %d",
		},
	},
	"int": locale.Map{
		"K":  "[1] الف‎ | [2] الفين‎ | [3-*] الوف",
